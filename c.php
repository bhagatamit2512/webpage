 ...
 <?php
   ...
   if(isset($_POST) & !empty($_POST)){
     $prodname = mysql_real_escape_string($_POST['productname']);
     $description = mysql_real_escape_string($_POST['productdescription']);
     $category = mysql_real_escape_string($_POST['productcategory']);
     ...
     $sql = mysql_query("UPDATE products SET name='$prodname',
       description='$description', catid='$category', price='$price', thumb='$filepath' WHERE id = '$id'");
 ...
 <section id="content">
   <div class="content-blog">
     ...
     <?php if(isset($smsg)){ ?><div class="alert alert-success" role="alert"> <?php echo $smsg; ?> </div><?php } ?>
       <?php
         $h = mysql_query("SELECT * FROM products WHERE id=$id");
       ...
       <form method="post" enctype="multipart/form-data">
         ...
         <div class="form-group">
           ...
           while ($catr = mysqli_fetch_assoc($catsql)) {
         ?>
